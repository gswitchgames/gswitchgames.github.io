function createUnityInstance(r, n, l) {
    function f(e, t) {
        if (!f.aborted && n.showBanner)
            return "error" == t && (f.aborted = !0),
            n.showBanner(e, t);
        switch (t) {
        case "error":
            console.error(e);
    ...
    function o(e) {
        ...
        (r += "\n" + (n = n.startsWith(r) ? n.substring(r.length) : n).trim()) && u.stackTraceRegExp && u.stackTraceRegExp.test(r) && h(r, e.filename || t && (t.fileName || t.sourceURL) || "", e.lineno || t && (t.lineNumber || t.line) || 0)
    }
    function e(e, t, r) {
        var n = e[t];
    ...
    for (t in e(n, "companyName", "Unity"),
    ...
    var s = ""
      ...
      , c = (document.addEventListener("webkitfullscreenchange", function(e) {
        document.webkitCurrentFullScreenElement === r ? r.style.width && (s = r.style.width,
        d = r.style.height,
        r.style.width = "100%",
        r.style.height = "100%") : s && (r.style.width = s,
        r.style.height = d,
        d = s = "")
    }),
    {
    ...
    function h(e, t, r) {
        u.startupErrorHandler ? u.startupErrorHandler(e, t, r) : u.errorHandler && u.errorHandler(e, t, r) || (console.log("Invoking error handler due to\n" + e),
        "function" == typeof dump && dump("Invoking error handler due to\n" + e),
        -1 != e.indexOf("UnknownError") || -1 != e.indexOf("Program terminated with exit(0)") || h.didShowErrorMessage || (-1 != (e = "An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING") ? e = "An exception has occurred, but exception handling has been disabled in this build. If you are the developer of this content, enable exceptions in your project WebGL player settings to be able to catch the exception or see the stack trace." : -1 != e.indexOf("Cannot enlarge memory arrays") ? e = "Out of memory. If you are the developer of this content, try allocating more memory to your WebGL build in the WebGL player settings." : -1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf("Invalid typed array length") && -1 == e.indexOf("out of memory") && -1 == e.indexOf("could not allocate memory") || (e = "The browser could not allocate enough memory for the WebGL content. If you are the developer of this content, try allocating less memory to your WebGL build in the WebGL player settings."),
        alert(e),
    ...
    function b(e, t) {
        if ("symbolsUrl" != e) {
            ...
            for (e in u.downloadProgress) {
                if (!(r = u.downloadProgress[e]).started)
                    return;
                i++,
    ...
    u.SystemInfo = function() {
        var e, t, r, n, o = navigator.userAgent + " ", i = [["Firefox", "Firefox"], ["OPR", "Opera"], ["Edg", "Edge"], ["SamsungBrowser", "Samsung Browser"], ["Trident", "Internet Explorer"], ["MSIE", "Internet Explorer"], ["Chrome", "Chrome"], ["CriOS", "Chrome on iOS Safari"], ["FxiOS", "Firefox on iOS Safari"], ["Safari", "Safari"]];
        function a(e, t, r) {
        ...
        var f = {
          ...
          , u = ((u = document.createElement("canvas")) && (gl = u.getContext("webgl2"),
        glVersion = gl ? 2 : 0,
                ...
                var t, r = {
                    "inflate.js": function(e, t, r) {
                        ...
                        a.prototype.push = function(e, t) {
                            ...
                            do {
                                ...
                                s.next_out = 0,
                                s.avail_out = l),
                                (r = u.inflate(s, b.Z_NO_FLUSH)) === b.Z_NEED_DICT && d && (a = "string" == typeof d ? h.string2buf(d) : "[object ArrayBuffer]" === m.call(d) ? new Uint8Array(d) : d,
                                r = u.inflateSetDictionary(this.strm, a)),
                                r === b.Z_BUF_ERROR && !0 === f && (r = b.Z_OK,
                                f = !1),
                                r !== b.Z_STREAM_END && r !== b.Z_OK)
                                    return this.onEnd(r),
                                    !(this.ended = !0)
                            } while (!s.next_out || 0 !== s.avail_out && r !== b.Z_STREAM_END && (0 !== s.avail_in || n !== b.Z_FINISH && n !== b.Z_SYNC_FLUSH) || ("string" === this.options.to ? (a = h.utf8border(s.output, s.next_out),
                            o = s.next_out - a,
                            ...
                            return (n = r === b.Z_STREAM_END ? b.Z_FINISH : n) === b.Z_FINISH ? (r = u.inflateEnd(this.strm),
                            this.onEnd(r),
                            this.ended = !0,
                            r === b.Z_OK) : n !== b.Z_SYNC_FLUSH || (this.onEnd(b.Z_OK),
                            !(s.avail_out = 0))
                        }
                        ,
                        ...
                        a.prototype.onEnd = function(e) {
                            e === b.Z_OK && ("string" === this.options.to ? this.result = this.chunks.join("") : this.result = c.flattenChunks(this.chunks)),
                            this.chunks = [],
                            this.err = e,
                    ...
                    "zlib/inflate.js": function(e, t, r) {
                        ...
                        function a(e) {
                            ...
                            t.hold = 0,
                            t.bits = 0,
                            t.lencode = t.lendyn = new R.Buf32(n),
                            t.distcode = t.distdyn = new R.Buf32(o),
                            t.sane = 1,
                            t.back = -1,
                            z) : N
                        }
                        ...
                        function l(e, t) {
                            ...
                            t = -t) : (r = 1 + (t >> 4),
                            t < 48 && (t &= 15)),
                            t && (t < 8 || 15 < t)) ? N : (null !== n.window && n.wbits !== t && (n.window = null),
                            n.wrap = r,
                            n.wbits = t,
                            s(e))
                        }
                        ...
                        function W(e, t, r, n) {
                            ...
                            n >= e.wsize ? (R.arraySet(e.window, t, r - e.wsize, e.wsize, 0),
                            e.wnext = 0,
                            e.whave = e.wsize) : (n < (o = e.wsize - e.wnext) && (o = n),
                            R.arraySet(e.window, t, r - n, o, e.wnext),
                            (n -= o) ? (R.arraySet(e.window, t, r - n, n, 0),
                            e.wnext = n,
                        ...
                        r.inflate = function(e, t) {
                            var r, n, o, i, a, s, l, d, f, u, c, h, b, m, g, w, p, v, k, y, _, x, S, E, U = 0, C = new R.Buf8(4), L = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
                            ...
                            e: for (; ; )
                                ...
                                case 6:
                                    ...
                                    R.arraySet(r.head.extra, n, i, h, _)),
                                    512 & r.flags && (r.check = A(r.check, n, h, i)),
                                    s -= h,
                                    i += h,
                                    r.length -= h),
                                    r.length))
                                ...
                                case 7:
                                    if (2048 & r.flags) {
                                        ...
                                        _ && h < s; )
                                            ;
                                        if (512 & r.flags && (r.check = A(r.check, n, h, i)),
                                        s -= h,
                                        i += h,
                                        _)
                                            break e
                                    ...
                                    if (r.last)
                                        ...
                                        case 1:
                                            ...
                                            if (j) {
                                                ...
                                                for (; T < 288; )
                                                    B.lens[T++] = 8;
                                                for (F(1, B.lens, 0, 288, H, 0, B.work, {
                                                    bits: 9
                                                }),
                                                T = 0; T < 32; )
                                                    B.lens[T++] = 5;
                                                F(2, B.lens, 0, 32, D, 0, B.work, {
                                                    bits: 5
                                                }),
                                                j = !1
                                            }
                                ...
                                case 18:
                                    ...
                                    x = F(0, r.lens, 0, 19, r.lencode, 0, r.work, S),
                                    r.lenbits = S.bits,
                                    x) {
                                ...
                                case 19:
                                    for (; r.have < r.nlen + r.ndist; ) {
                                        for (; w = (U = r.lencode[d & (1 << r.lenbits) - 1]) >>> 16 & 255,
                                        p = 65535 & U,
                                        !((g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                    ...
                                    x = F(1, r.lens, 0, r.nlen, r.lencode, 0, r.work, S),
                                    r.lenbits = S.bits,
                                    x) {
                                    ...
                                    x = F(2, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, S),
                                    r.distbits = S.bits,
                                    x) {
                                ...
                                case 21:
                                    ...
                                    for (r.back = 0; w = (U = r.lencode[d & (1 << r.lenbits) - 1]) >>> 16 & 255,
                                    p = 65535 & U,
                                    !((g = U >>> 24) <= f); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (w && 0 == (240 & w)) {
                                        for (v = g,
                                        k = w,
                                        y = p; w = (U = r.lencode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255,
                                        p = 65535 & U,
                                        !(v + (g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 22:
                                    ...
                                    r.mode = 23;
                                case 23:
                                    for (; w = (U = r.distcode[d & (1 << r.distbits) - 1]) >>> 16 & 255,
                                    p = 65535 & U,
                                    !((g = U >>> 24) <= f); ) {
                                        if (0 === s)
                                            break e;
                                    ...
                                    if (0 == (240 & w)) {
                                        for (v = g,
                                        k = w,
                                        y = p; w = (U = r.distcode[y + ((d & (1 << v + k) - 1) >> v)]) >>> 16 & 255,
                                        p = 65535 & U,
                                        !(v + (g = U >>> 24) <= f); ) {
                                            if (0 === s)
                                                break e;
                                ...
                                case 27:
                                    if (r.wrap) {
                                        ...
                                        e.total_out += c,
                                        r.total += c,
                                        c && (e.adler = r.check = (r.flags ? A : O)(r.check, o, c, a - c)),
                                        c = l,
                                        (r.flags ? d : P(d)) !== r.check) {
                            ...
                            r.hold = d,
                            r.bits = f,
                            (r.wsize || c !== e.avail_out && r.mode < 30 && (r.mode < 27 || 4 !== t)) && W(e, e.output, e.next_out, c - e.avail_out) ? (r.mode = 31,
                            -4) : (u -= e.avail_in,
                            c -= e.avail_out,
                            e.total_in += u,
                            e.total_out += c,
                            r.total += c,
                            r.wrap && c && (e.adler = r.check = (r.flags ? A : O)(r.check, o, c, e.next_out - c)),
                        ...
                        r.inflateSetDictionary = function(e, t) {
                            var r, n = t.length;
                            return !e || !e.state || 0 !== (r = e.state).wrap && 11 !== r.mode ? N : 11 === r.mode && O(1, t, n, 0) !== r.check ? -3 : W(e, t, n, n) ? (r.mode = 31,
                            -4) : (r.havedict = 1,
                            z)
                        }
                        ,
                    ...
                    "zlib/inffast.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t) {
                            var r, n, o, i, a, s, l = e.state, d = e.next_in, f = e.input, u = d + (e.avail_in - 5), c = e.next_out, h = e.output, b = c - (t - e.avail_out), m = c + (e.avail_out - 257), g = l.dmax, w = l.wsize, p = l.whave, v = l.wnext, k = l.window, y = l.hold, _ = l.bits, x = l.lencode, S = l.distcode, E = (1 << l.lenbits) - 1, U = (1 << l.distbits) - 1;
                            e: do {
                                for (_ < 15 && (y += f[d++] << _,
                                _ += 8,
                                y += f[d++] << _,
                    ...
                    "zlib/inftrees.js": function(e, t, r) {
                        ...
                        t.exports = function(e, t, r, n, o, i, a, s) {
                            for (var l, d, f, u, c, h, b, m, g, w = s.bits, p = 0, v = 0, k = 0, y = 0, _ = 0, x = 0, S = 0, E = 0, U = 0, C = 0, L = null, T = 0, B = new I.Buf16(16), R = new I.Buf16(16), O = null, A = 0, p = 0; p <= 15; p++)
                                B[p] = 0;
                            for (v = 0; v < n; v++)
                                B[t[r + v]]++;
                            for (_ = w,
                            ...
                            0 === y)
                                ...
                                for (; ; ) {
                                    ...
                                    0),
                                    l = 1 << (b = p - S),
                                    k = d = 1 << x; o[c + (C >> S) + (d -= l)] = b << 24 | m << 16 | g | 0,
                                    0 !== d; )
                                        ;
                                    for (l = 1 << p - 1; C & l; )
                                        l >>= 1;
                                    ...
                                    if (_ < p && (C & u) !== f) {
                                        for (c += k,
                                        E = 1 << (x = p - (S = 0 === S ? _ : S)); x + S < y && !((E -= B[x + S]) <= 0); )
                                            x++,
                                            E <<= 1;
                                        if (U += 1 << x,
                                        1 === e && 852 < U || 2 === e && 592 < U)
    ...
    function g(d) {
        return new Promise(function(s, e) {
            b(d);
            // Kiểm tra nếu u[d] là mảng (nhiều file nhỏ)
            if (Array.isArray(u[d])) {
                ...
                // Tải từng file và cập nhật progress
                Promise.all(urls.map(function(url, index) {
                    return new Promise(function(resolve, reject) {
                        ...
                        xhr.addEventListener("progress", function(evt) {
                            if (evt.lengthComputable) {
                                // Cập nhật progress cho từng phần
                                var partLoaded = loadedBuffers[index] ? loadedBuffers[index].byteLength : 0;
                                var newLoaded = evt.loaded;
                                loadedSize = loadedSize - partLoaded + newLoaded;
                                loadedBuffers[index] = evt.total ? {byteLength: newLoaded, total: evt.total} : {byteLength: newLoaded, total: 0};
                                
                                // Tính tổng total nếu có
                                if (evt.total && !totalSize) {
                                    totalSize = urls.reduce(function(sum, u, i) {
                                        return sum + (loadedBuffers[i] && loadedBuffers[i].total ? loadedBuffers[i].total : 0);
                                    }, 0);
                                }
                                
                                // Gọi b(d, e) để cập nhật progress
                                b(d, {
                                    type: "progress",
                                    lengthComputable: evt.lengthComputable,
                                    total: totalSize || loadedSize,
                                    loaded: loadedSize
                                });
                            }
                        });
                        xhr.addEventListener("load", function(evt) {
                            ...
                            // Cập nhật progress khi load xong từng phần
                            b(d, {
                                type: "progress",
                    ...
                    // Ghép tất cả các buffer lại thành một Uint8Array
                    ...
                    // Xử lý dữ liệu đã tải (giống như code cũ)
                    handleDownloadedData(d, merged, s);
                }).catch(function(err) {
                    var t = "Failed to download files for " + d + ": " + err.message;
                    "file:" == location.protocol ? f(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error") : console.error(t);
                    e(err);
                });
            } else {
                // Code cũ: tải 1 file duy nhất
                ...
                l.addEventListener("load", function(e) {
                    b(d, e);
                    var o = new Uint8Array(l.response);
                    handleDownloadedData(d, o, s);
                }),
                l.addEventListener("error", function(e) {
                    var t = "Failed to download file " + u[d];
                    "file:" == location.protocol ? f(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error") : console.error(t);
                    e(new Error(t));
                }),
                l.send()
    ...
    function handleDownloadedData(d, o, a) {
        var t, r, n, i = u[d];
        for (t in m)
            if (m[t].hasUnityMarker(o))
                return void (i && console.log('You can reduce startup time if you configure your web server to add "Content-Encoding: ' + t + '" response header when serving "' + i + '" file.'),
                (t = m[t]).worker || (r = URL.createObjectURL(new Blob(["this.require = ", t.require.toString(), "; this.decompress = ", t.decompress.toString(), "; this.onmessage = ", function(e) {
                    e = {
                        id: e.data.id,
                ...
                t.worker = new Worker(r),
                t.worker.onmessage = function(e) {
                    e.data.ready ? URL.revokeObjectURL(r) : (this.callbacks[e.data.id](e.data.decompressed),
                    delete this.callbacks[e.data.id])
                }
                ,
                t.worker.callbacks = {},
                t.worker.nextCallbackId = 0),
                n = t.worker.nextCallbackId++,
                t.worker.callbacks[n] = a,
    ...
    function w() {
        Promise.all([g("frameworkUrl").then(function(e) {
                    ...
                    if ("undefined" == typeof unityFramework || !unityFramework) {
                        ...
                        for (e in t) {
                            ...
                            if (u.frameworkUrl.endsWith("." + n[0]))
                                return r = "Unable to parse " + u.frameworkUrl + "!",
                                "file:" == location.protocol ? void f(r + " Loading pre-compressed (brotli or gzip) content via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host compressed Unity content, or use the Unity Build and Run option.", "error") : (r += ' This can happen if build compression was enabled but web server hosting the content was misconfigured to not serve the file with HTTP Response Header "Content-Encoding: ' + n[1] + '" present. Check browser Console and Devtools Network tab to debug.',
        ...
        u.preRun.push(function() {
            ...
            e.then(function(e) {
                ...
                for (r += 4; r < o; ) {
                    ...
                    r += s;
                    for (var d = 0, f = l.indexOf("/", d) + 1; 0 < f; d = f,
                    f = l.indexOf("/", d) + 1)
    ...
    return new Promise(function(e, t) {
        u.SystemInfo.hasWebGL ? u.SystemInfo.hasWasm ? (1 == u.SystemInfo.hasWebGL && u.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'),
